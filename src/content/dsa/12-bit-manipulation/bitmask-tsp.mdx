...
estimatedMinutes: 8
prerequisites: []
summary: "Encode the visited set as a bitmask and DP over (mask, current city). Shrinks TSP from n! permutation search to O(2^n · n²)."
complexity:
  time: "O(2^n · n²)"
  space: "O(2^n · n)"
commonPitfalls:
...
## Practice — LeetCode
- [943 Find the Shortest Superstring (Hard)](https://leetcode.com/problems/find-the-shortest-superstring/) — TSP over string-overlap costs.
- [1125 Smallest Sufficient Team (Hard)](https://leetcode.com/problems/smallest-sufficient-team/) — set-cover bitmask DP.
- [691 Stickers to Spell Word (Hard)](https://leetcode.com/problems/stickers-to-spell-word/) — bitmask of needed letters.
- [847 Shortest Path Visiting All Nodes (Hard)](https://leetcode.com/problems/shortest-path-visiting-all-nodes/) — BFS on `(node, mask)`.
- [1349 Maximum Students Taking Exam (Hard)](https://leetcode.com/problems/maximum-students-taking-exam/) — row-by-row bitmask DP.
- [1986 Minimum Number of Work Sessions (Med)](https://leetcode.com/problems/minimum-number-of-work-sessions-to-finish-the-tasks/) — submask DP.
- [1601 Maximum Number of Achievable Transfer Requests (Hard)](https://leetcode.com/problems/maximum-number-of-achievable-transfer-requests/) — enumerate request subsets.
- [1066 Campus Bikes II (Med)](https://leetcode.com/problems/campus-bikes-ii/) — assignment via bitmask DP.
- [1681 Minimum Incompatibility (Hard)](https://leetcode.com/problems/minimum-incompatibility/) — subset partition DP.
- [526 Beautiful Arrangement (Med)](https://leetcode.com/problems/beautiful-arrangement/) — permutation count via mask DP.
