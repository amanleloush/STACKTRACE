...
estimatedMinutes: 6
prerequisites: []
summary: "One-page recall for bit manipulation: core ops, XOR pairing, popcount, subset enumeration, and bitmask DP skeletons."
commonPitfalls:
...
### Power of Two — n & (n-1) trick

<Anim id="power-of-two" />

### Bitmask TSP — dp[mask][i]
