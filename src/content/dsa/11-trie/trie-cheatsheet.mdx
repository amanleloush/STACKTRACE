...
estimatedMinutes: 5
prerequisites: []
summary: "One-page recall for tries — a tree of characters where each path is a prefix, insert/lookup in O(L), reach for it whenever the problem repeats prefix queries."
commonPitfalls:
...
### Word Search II — grid DFS pruned by trie

<Anim id="word-search-ii" />

### Autocomplete — trie + top-K cache
