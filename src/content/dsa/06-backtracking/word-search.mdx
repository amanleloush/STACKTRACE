...
estimatedMinutes: 6
prerequisites: []
summary: "Launch DFS from every first-letter match; temporarily mark the cell, recurse for the next letter, then unmark — that's what makes this backtracking and not plain DFS."
complexity:
  time: "O(m·n · 4^L)"
  space: "O(L)"
commonPitfalls:
...
## Practice — LeetCode
- [79. Word Search (Medium)](https://leetcode.com/problems/word-search/) — the canonical version.
- [212. Word Search II (Hard)](https://leetcode.com/problems/word-search-ii/) — Trie + grid DFS.
- [980. Unique Paths III (Hard)](https://leetcode.com/problems/unique-paths-iii/) — visit every empty cell once.
- [1219. Path with Maximum Gold (Medium)](https://leetcode.com/problems/path-with-maximum-gold/) — DFS that returns a max.
- [489. Robot Room Cleaner (Hard)](https://leetcode.com/problems/robot-room-cleaner/) — DFS in an unknown grid with movement primitives.
- [332. Reconstruct Itinerary (Hard)](https://leetcode.com/problems/reconstruct-itinerary/) — backtracking on edges (Hierholzer).
- [22. Generate Parentheses (Medium)](https://leetcode.com/problems/generate-parentheses/) — constrained string builder.
- [51. N-Queens (Hard)](https://leetcode.com/problems/n-queens/) — backtracking with constraint sets.
- [17. Letter Combinations of a Phone Number (Medium)](https://leetcode.com/problems/letter-combinations-of-a-phone-number/) — fixed-depth tree.
- [320. Generalized Abbreviation (Medium)](https://leetcode.com/problems/generalized-abbreviation/) — per-char choice.
