...
estimatedMinutes: 6
prerequisites: []
summary: "One-page recall for graph algorithms — pick the right tool by what you're optimizing for: weighted shortest path, ordering, connectivity, spanning, or SCC."
commonPitfalls:
...
### Kruskal MST — sorted edges + union-find

<Anim id="kruskal" />

### Prim MST — grow tree by lightest crossing edge

<Anim id="prim" />

### Tarjan SCC — DFS with index / lowlink
