...
estimatedMinutes: 10
prerequisites: []
summary: "One DFS pass that uses disc/low timestamps and an on-stack flag to peel strongly connected components off a directed graph in linear time."
complexity:
  time: "O(V + E)"
  space: "O(V)"
commonPitfalls:
...
#### Practice — LeetCode
- [1192 Critical Connections in a Network (Hard)](https://leetcode.com/problems/critical-connections-in-a-network/) — the canonical bridges problem.
- [1568 Minimum Number of Days to Disconnect Island (Hard)](https://leetcode.com/problems/minimum-number-of-days-to-disconnect-island/) — articulation points on grid.
- [1489 Find Critical and Pseudo-Critical Edges in MST (Hard)](https://leetcode.com/problems/find-critical-and-pseudo-critical-edges-in-minimum-spanning-tree/) — adjacent topic; Kruskal-based.
- [802 Find Eventual Safe States (Med)](https://leetcode.com/problems/find-eventual-safe-states/) — SCC + condensation reasoning.
- [685 Redundant Connection II (Hard)](https://leetcode.com/problems/redundant-connection-ii/) — directed cycles; Tarjan helps.
- [1559 Detect Cycles in 2D Grid (Med)](https://leetcode.com/problems/detect-cycles-in-2d-grid/) — DFS with parent tracking.
- [207 Course Schedule (Med)](https://leetcode.com/problems/course-schedule/) — cycle = non-trivial SCC.
- [210 Course Schedule II (Med)](https://leetcode.com/problems/course-schedule-ii/) — SCC on a DAG must all be singletons.
- [947 Most Stones Removed (Med)](https://leetcode.com/problems/most-stones-removed-with-same-row-or-column/) — components via DSU; SCC overkill but instructive.
- [928 Minimize Malware Spread II (Hard)](https://leetcode.com/problems/minimize-malware-spread-ii/) — articulation-point flavored.
