---
title: "Jump Game (greedy farthest)"
phase: "10-greedy"
order: 2
tags: ["greedy"]
premium: false
...
estimatedMinutes: 6
prerequisites: []
summary: "Track the farthest reachable index in one sweep — if i ever passes reach you're stuck. Jump Game II layers BFS-by-level on top to count minimum jumps."
complexity:
  time: "O(n)"
  space: "O(1)"
commonPitfalls:
...
#### Practice — LeetCode
- [55 Jump Game (Med)](https://leetcode.com/problems/jump-game/) — canonical reachability sweep.
- [45 Jump Game II (Med)](https://leetcode.com/problems/jump-game-ii/) — minimum jumps via BFS-by-level.
- [1306 Jump Game III (Med)](https://leetcode.com/problems/jump-game-iii/) — graph reachability with ±nums[i].
- [1340 Jump Game V (Hard)](https://leetcode.com/problems/jump-game-v/) — DP with memo, not greedy.
- [1696 Jump Game VI (Med)](https://leetcode.com/problems/jump-game-vi/) — monotonic deque on DP.
- [134 Gas Station (Med)](https://leetcode.com/problems/gas-station/) — circular variant of the frontier idea.
- [871 Minimum Number of Refueling Stops (Hard)](https://leetcode.com/problems/minimum-number-of-refueling-stops/) — heap of skipped stations.
- [1024 Video Stitching (Med)](https://leetcode.com/problems/video-stitching/) — Jump Game II on intervals.
- [1326 Minimum Number of Taps to Open to Water a Garden (Hard)](https://leetcode.com/problems/minimum-number-of-taps-to-open-to-water-a-garden/) — intervals → Jump Game II.
- [763 Partition Labels (Med)](https://leetcode.com/problems/partition-labels/) — last-occurrence farthest pointer.
