...
estimatedMinutes: 5
prerequisites: []
summary: "A min-heap holding the current head of each list gives the next output element in O(log K); after popping push the popped head's successor."
complexity:
  time: "O(N log K)"
  space: "O(K)"
commonPitfalls:
...
## Practice — LeetCode
- [23 Merge k Sorted Lists (Hard)](https://leetcode.com/problems/merge-k-sorted-lists/) — the canonical problem.
- [21 Merge Two Sorted Lists (Easy)](https://leetcode.com/problems/merge-two-sorted-lists/) — the K=2 base case, no heap needed.
- [88 Merge Sorted Array (Easy)](https://leetcode.com/problems/merge-sorted-array/) — in-place pointer variant.
- [378 Kth Smallest in Sorted Matrix (Med)](https://leetcode.com/problems/kth-smallest-element-in-a-sorted-matrix/) — rows act as sorted lists.
- [632 Smallest Range Covering Elements from K Lists (Hard)](https://leetcode.com/problems/smallest-range-covering-elements-from-k-lists/) — heap + sliding max.
- [295 Find Median from Data Stream (Hard)](https://leetcode.com/problems/find-median-from-data-stream/) — two-heap pattern.
- [373 Find K Pairs with Smallest Sums (Med)](https://leetcode.com/problems/find-k-pairs-with-smallest-sums/) — heap over pairs (i, j).
- [1675 Minimize Deviation in Array (Hard)](https://leetcode.com/problems/minimize-deviation-in-array/) — heap of transformable max values.
- [1953 Maximum Number of Weeks for Which You Can Work (Med)](https://leetcode.com/problems/maximum-number-of-weeks-for-which-you-can-work/) — scheduling with priority.
- [1882 Process Tasks Using Servers (Med)](https://leetcode.com/problems/process-tasks-using-servers/) — two heaps: free and busy servers.
