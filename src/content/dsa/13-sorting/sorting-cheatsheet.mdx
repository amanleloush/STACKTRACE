...
estimatedMinutes: 6
prerequisites: []
summary: "One-page recall for sorting: comparison table across 9 algorithms, skeletons for quicksort/mergesort/counting, and the comparison-sort lower bound."
commonPitfalls:
...
### Insertion sort — grow the sorted prefix

<Anim id="insertion-sort" />

### Selection sort — pick the min, swap to front

<Anim id="selection-sort" />

### Merge sort — merge two halves
...
### Heap sort — build max-heap, repeatedly swap root to tail

<Anim id="heap-sort" />

### Counting sort — tally and emit

<Anim id="counting-sort" />

### Radix sort — LSD, stable per-digit
