...
estimatedMinutes: 5
prerequisites: []
summary: "Three-pointer flip — save next, rewrite, advance. The canonical pointer-surgery drill that every list problem reuses."
complexity:
  time: "O(n)"
  space: "O(1)"
commonPitfalls:
...
## Practice — LeetCode
- [Reverse Linked List (Easy)](https://leetcode.com/problems/reverse-linked-list/) — the canonical version.
- [Reverse Linked List II (Med)](https://leetcode.com/problems/reverse-linked-list-ii/) — reverse positions m..n with a dummy head.
- [Reverse Nodes in K-Group (Hard)](https://leetcode.com/problems/reverse-nodes-in-k-group/) — chained partial reversals.
- [Swap Nodes in Pairs (Med)](https://leetcode.com/problems/swap-nodes-in-pairs/) — reverse in groups of 2.
- [Palindrome Linked List (Easy)](https://leetcode.com/problems/palindrome-linked-list/) — reverse second half, compare.
- [Reorder List (Med)](https://leetcode.com/problems/reorder-list/) — split, reverse second half, weave.
- [Rotate List (Med)](https://leetcode.com/problems/rotate-list/) — find tail, close ring, break at offset.
- [Partition List (Med)](https://leetcode.com/problems/partition-list/) — two dummy heads, then concatenate.
- [Odd Even Linked List (Med)](https://leetcode.com/problems/odd-even-linked-list/) — interleave with two dummy heads.
- [Reverse Nodes in Even Length Groups (Med)](https://leetcode.com/problems/reverse-nodes-in-even-length-groups/) — conditional group reversal.
